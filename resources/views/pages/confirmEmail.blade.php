...
@section('content')
    ...
    <div class="justify-content-center m-auto my-5 py-5 text-center w-50" style="background: #f0eeee;">
        ...
        <h3 class="pt-3">CONFIRM YOUR EMAIL ADDRESS</h3>
        <a>A confirmation email has been sent to example@gmail.com.<br>
        ...
        {{Form::number('confCode','',['class'=>'form-control w-25 m-auto mt-3 text-center','style'=>'border:none; outline:none; background:none; border-bottom: 1px #000000 solid; border-radius:0%;','placeholder'=>'INPUT CODE'])}}
        {{Form::submit('CONFIRM EMAIL', ['class'=>'btn btn-dark mt-3','style'=>'border-radius:0%; width: 170px;'])}}
