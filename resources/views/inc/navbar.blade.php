<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #393E41;" >
  <!-- Container wrapper -->
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width:70%;">
      <!-- Left links -->
      <ul class="navbar-nav me-auto ps-lg-0 align-items-center" style="padding-left: 0.15rem;">
        <li class="nav-item d-flex align-items-center">
          <img src="/img/tnglogo.png" alt="" width="90px" height="30px">
          <a class="nav-link text-white me-5" href="/home" style="font-size: 30px; ">True North Auction</a>
        </li>
        <!-- Navbar dropdown -->
        <li class="nav-item dropdown dropdown-hover position-static me-5 text-dark">
          <a class="nav-link text-white" href="#" id="navbarDropdown" role="button"
            data-mdb-toggle="dropdown" aria-expanded="false">
            PRE-LOVED
          </a>
          <!-- Dropdown menu -->
          <div class="dropdown-menu mt-0 w-25" aria-labelledby="navbarDropdown" style="border: none;
                          ">
            <div class="container">
              <div class="row my-4">
        ...
        <li class="nav-item dropdown dropdown-hover position-static me-5">
          <a class="nav-link  text-white" href="#" id="navbarDropdown" role="button"
            data-mdb-toggle="dropdown" aria-expanded="false">
            BRAND NEW
          </a>
