 ...
 <div class="m-5">
  <footer class="py-5">
    ...
    <div class="row py-3 px-3">
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          <li class="nav-item mt-2"><a href="/contactus" class="nav-link p-0 text-muted">Contact Us</a></li>
      ...
      {{-- <div class="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <div class="d-flex flex-column flex-sm-row gap-2">
            ...
            <input id="newsletter1" type="text" class="form-control w-100" placeholder="Email address">
            <button class="form-btn " type="button">Subscribe</button>
          </div>
        </form>
      </div>
    </div> --}}
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      <p>&copy; 2022 True North Garments and Subcontractor Inc. All rights reserved.</p>
